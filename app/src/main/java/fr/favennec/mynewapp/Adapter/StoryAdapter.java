...
import fr.favennec.appsoft.AddStoryActivity;
...
import fr.favennec.appsoft.StoryActivity;
...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (holder.getAdapterPosition() == 0) {
            myStory(holder.addstory_text, holder.cardView_add_Story, false);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (holder.getAdapterPosition() == 0) {
                    myStory(holder.addstory_text, holder.cardView_add_Story, true);
                } else {
                    Intent intent = new Intent(mContext, StoryActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public CardView cardView_add_Story;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            cardView_add_Story = itemView.findViewById(R.id.cardView_add_Story);
    ...
    private void myStory (TextView textView, CardView cardView, boolean click) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (click) {
                    if (count >0 ) {
                        ...
                        Intent intent = new Intent(mContext, AddStoryActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        mContext.startActivity(intent);
